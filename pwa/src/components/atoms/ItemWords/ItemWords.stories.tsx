...
export default {
    ...
    argTypes: {
      ...
      author: {
        ...
        description: 'Display author of the item. Could be a content creator or just website name.',
        control: {
          type: 'select',
          options: [
            'unknown',
      ...
      date: {
        ...
        description: 'Date the item was created or last edited. Defaults to current date.',
        control: {
          type: 'date',
        }
      },
      length: {
        ...
        description: 'How long it takes to read/watch/listen through the item fully.',
        control: {
          type: 'text',
        }
      },

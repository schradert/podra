...
import { capitalize, domainParser } from "../../scripts/functions";
import { Select, Chip, MenuItem, ListItemText, Input } from "@material-ui/core";
        ...
        <div className={styles.chips}>
          {(sel as string[]).map((val: unknown, i: number) => (
            <Chip
              ...
              icon={
                <img
                  src={`https://${val as string}.com/favicon.ico`}
                  alt={val as string}
                  width={24}
                  height={24}
                />
